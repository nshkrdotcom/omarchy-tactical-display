...
2026-09-07 shared-presentation acceptance: `053ce14` passed 50 cycles and the full ten-minute soak, recorded in `/tmp/tactical-shared-chrome-native.json`. Whole-shell peak growth was 84.73 MiB during lifecycle and 115.20 MiB during soak (configured ceiling 128 MiB), with no FD or child growth. Two earlier failed runs remain in their original evidence files; the pass does not retrospectively determine their cause. Bar-click appearance was checked separately in native captures, not by the lifecycle runner's automated manual-gate fields.
